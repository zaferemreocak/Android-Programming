...
public class ViewContact extends Activity 
{
   ...
   private Button watchTrailerButton;  // displays YouTube search with the corresponding movie title

   String searchParam;  // movie title to be searched on YouTube
   ...
   public void onCreate(Bundle savedInstanceState) 
   {
      ...
      watchTrailerButton = (Button) findViewById(R.id.watchTrailerButton);
      ...
      watchTrailerButton.setOnClickListener(new View.OnClickListener() {
         public void onClick(View v) {
            ...
            intent.putExtra("query", searchParam);
   ...
   private class LoadContactTask extends AsyncTask<Long, Object, Cursor> 
   {
      ...
      protected void onPostExecute(Cursor result)
      {
         ...
         searchParam = result.getString(nameIndex);
